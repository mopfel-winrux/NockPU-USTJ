...
\node[above=1.2cm of mtu, font=\small\bfseries\urbitfont] {NockPU Core};
\node[above=0.6cm of execute, font=\small\bfseries\urbitfont] {Execution Units};
\node[above=0.6cm of memunit, font=\small\bfseries\urbitfont] {Memory Subsystem};
